<!-- 来源: https://developers.weixin.qq.com/doc/service/api/usermanage/userinfo/api_updateremark.html -->
...
- 调用方法：officialAccount.user.updateRemark
...
| 参数名 | 类型 | 必填 | 示例 | 说明 |
| --- | --- | --- | --- | --- ||
| openid | string | 是 | oDF3iY9ffA-hqb2vVvbr7qxf6A0Q | 用户标识 |
| remark | string | 是 | pangzi | 新的备注名，长度必须小于30字节 |
...
| 40092 | invalid remark name | 换个备注名 |
