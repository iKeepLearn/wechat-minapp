<!-- 来源: https://developers.weixin.qq.com/doc/service/api/usermanage/tag/api_updatetag.html -->
...
- 调用方法：officialAccount.tags.update
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| id | number | 是 | 标签id，由微信分配 |
| name | string | 是 | 修改的标签名，UTF8编码 |
...
| 45157 | invalid tag name | 检查标签名 |
| 45158 | tag name too long | 调小标签名长度 |
