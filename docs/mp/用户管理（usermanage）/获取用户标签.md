<!-- 来源: https://developers.weixin.qq.com/doc/service/api/usermanage/tag/api_gettagidlist.html -->
...
- 调用方法：officialAccount.tags.getUserTagList
...
| 参数名 | 类型 | 必填 | 示例 | 说明 |
| --- | --- | --- | --- | --- |
| openid | string | 是 | ocYxcuBt0mRugKZ7tGAHPnUaOW7Y | 用户 openid |
...
| 43004 | require subscribe | 该 openid 未关注当前账号 |
