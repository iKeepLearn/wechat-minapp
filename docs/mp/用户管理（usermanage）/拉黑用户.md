<!-- 来源: https://developers.weixin.qq.com/doc/service/api/usermanage/userinfo/api_batchblacklist.html -->
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- ||
| openid_list | array | 是 | 需要拉黑的openid列表 |
...
| 268487001 | system busy, please try later | 稍后重试 |
