<!-- 来源: https://developers.weixin.qq.com/doc/service/api/wedata/news/api_getarticleread.html -->
...
接口英文名：getarticleread

本接口用于获取某天所有被阅读过的发表内容的阅读指标。
