<!-- 来源: https://developers.weixin.qq.com/doc/service/api/qrcode/shorten/api_fetchshorten.html -->
...
- 调用方法：officialAccount.shorten.fetch
...
| 参数名 | 类型 | 必填 | 示例 | 说明 |
| --- | --- | --- | --- | --- |
| short_key | string | 是 | iTqRJFSEqk9RvPk | 短key |
...
| errcode | number | 错误码 |
| errmsg | string | 错误信息 |
| long_data | string | 长信息 |
| create_time | timestamp | 创建的时间戳 |
| expire_seconds | number | 剩余的过期秒数 |
...
| 9410012 | short_key不存在/过期/不属于本账号 |  |
