<!-- 来源: https://developers.weixin.qq.com/miniprogram/dev/server/API/weixin-express/same_city_distribution/api_intracity_queryflow.html -->
...
| pay_status | string | 支付状态，FAIL：支付失败
SUCCESS:支付成功 | - |
