<!-- 来源: https://developers.weixin.qq.com/miniprogram/dev/server/API/weixin-express/freight/api_insurance_freight_applypay.html -->

# # 申请支付

> 接口应在服务器端调用，不可在前端（小程序、网页、APP等）直接调用，具体可参考接口调用指南。

接口英文名：insurance_freight_applypay
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| order_id | number | 是 | 充值订单id，与申请充值订单号保持一致，js等语言防止精度错误传string |
