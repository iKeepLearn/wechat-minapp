<!-- 来源: https://developers.weixin.qq.com/miniprogram/dev/server/API/openApi-mgnt/api_clearquota.html -->
...
1、如果要清空公众号的接口的quota，则需要用公众号的access_token；如果要清空小程序的接口的quota，则需要用[小程序的access_token](../mp-access-token/api_getaccesstoken) ；如果要清空第三方平台的接口的quota，则需要用[第三方平台的component_access_token](https://developers.weixin.qq.com/doc/oplatform/openApi/ticket-token/api_getcomponentaccesstoken) 。如此类推。
