<!-- 来源: https://developers.weixin.qq.com/miniprogram/dev/server/API/dramaOthersAPI/api_getfinderevent.html -->
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| event_id_list | array | 否 | 筛选短剧合作推广活动 |
...
| 参数名 | 类型 | 说明 |
| --- | --- | --- |
| finder_event_list | objarray | 推广计划数组 |
| errcode | number | 错误码 |
| errmsg | string | 错误信息 |
...
| 参数名 | 类型 | 说明 |
| --- | --- | --- |
| encrypted_event_id | string | 活动id |
| event_name | string | 活动名 |
| event_url | string | 活动链接 |
| src_appid | string | 提审小程序id |
| drama_id | string | 提审剧目id |
