<!-- 来源: https://developers.weixin.qq.com/miniprogram/dev/server/API/dramaOthersAPI/api_developergetiaadrama.html -->

# # 获取短剧变现类型

> 接口应在服务器端调用，不可在前端（小程序、网页、APP等）直接调用，具体可参考接口调用指南。

接口英文名：developerGetIaaDrama

获取已设置短剧的变现类型。单次请求限制最多设置100个短剧。
...
| iaa_type | number | 短剧变现类型。 1-纯IAA；2-纯IAP；3-IAAP混合变现 |
| vip_flag | number | 是否存在会员功能。 1-有；2-无 |
