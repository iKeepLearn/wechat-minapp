<!-- 来源: https://developers.weixin.qq.com/miniprogram/dev/server/API/dramaOthersAPI/api_developergetpublisheddrama.html -->

# # 获取已上架短剧

> 接口应在服务器端调用，不可在前端（小程序、网页、APP等）直接调用，具体可参考接口调用指南。

接口英文名：developerGetPublishedDrama

开发者可以通过该接口查询通过“[短剧上架设置接口](api_developerpublishdrama) ”设置上架的短剧。
