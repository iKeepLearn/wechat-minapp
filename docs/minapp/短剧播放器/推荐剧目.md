<!-- 来源: https://developers.weixin.qq.com/miniprogram/dev/server/API/dramaOthersAPI/api_developersetrecmddrama.html -->
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| entry_type | number | 是 | 1-剧结束 2-选集最右侧推荐 3-剧集profile页相关推荐 |
| src_appid | string | 否 | 提审方小程序的appid |
| drama_id | string | 否 | 提审的剧目id |
| list | objarray | 否 | list |
