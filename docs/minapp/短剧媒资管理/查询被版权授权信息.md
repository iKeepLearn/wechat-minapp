<!-- 来源: https://developers.weixin.qq.com/miniprogram/dev/server/API/minidrama/authorizecopyright/api_getcopyrightauthorizedlist.html -->
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| authorizer_appid | string | 否 | 授权方小程序id，不填表示查全部。 |
