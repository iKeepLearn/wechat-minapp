<!-- 来源: https://developers.weixin.qq.com/miniprogram/dev/server/API/VirtualPayment/api_start_publish_goods.html -->

# # 启动批量发布道具任务

> 接口应在服务器端调用，不可在前端（小程序、网页、APP等）直接调用，具体可参考接口调用指南。

接口英文名：start_publish_goods
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| publish_item | objarray | 是 | 发布的商品列表 |
