<!-- 来源: https://developers.weixin.qq.com/miniprogram/dev/server/API/VirtualPayment/api_response_complaint.html -->

# # 回复用户

> 接口应在服务器端调用，不可在前端（小程序、网页、APP等）直接调用，具体可参考接口调用指南。

接口英文名：response_complaint
...
| response_content | string | 是 | 回复内容 |
| response_images | array | 是 | 每一项的内容为string，传upload_vp_file接口返回的file_id |
