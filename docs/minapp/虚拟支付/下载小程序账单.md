<!-- 来源: https://developers.weixin.qq.com/miniprogram/dev/server/API/VirtualPayment/api_download_bill.html -->
...
| 参数名 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| begin_ds | number | 是 | 起始时间（如20230801） |
| end_ds | number | 是 | 截止时间（如20230810） |
