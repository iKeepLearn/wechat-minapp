<!-- 来源: https://developers.weixin.qq.com/miniprogram/dev/server/API/VirtualPayment/api_query_upload_goods.html -->

# # 查询批量上传道具任务

> 接口应在服务器端调用，不可在前端（小程序、网页、APP等）直接调用，具体可参考接口调用指南。

接口英文名：query_upload_goods
...
| upload_status | number | 0-上传中 1-id已经存在 2-上传成功 3-上传失败 |
