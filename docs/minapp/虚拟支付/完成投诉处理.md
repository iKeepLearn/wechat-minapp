<!-- 来源: https://developers.weixin.qq.com/miniprogram/dev/server/API/VirtualPayment/api_complete_complaint.html -->

# # 完成投诉处理

> 接口应在服务器端调用，不可在前端（小程序、网页、APP等）直接调用，具体可参考接口调用指南。

接口英文名：complete_complaint
...
| complaint_id | string | 是 | 投诉id，获取投诉列表接口返回 |
