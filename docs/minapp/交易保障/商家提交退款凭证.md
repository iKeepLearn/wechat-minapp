<!-- 来源: https://developers.weixin.qq.com/miniprogram/dev/server/API/transaction-guarantee/complaint/api_submitrefund.html -->
...
| mediaIdList | array | 是 | 图片的id list 图片 id 列表，可参考新增素材（图片数组mediaIdList跟内容content二选一） |
