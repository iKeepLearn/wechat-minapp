<!-- 来源: https://developers.weixin.qq.com/miniprogram/dev/server/API/hardware-device/api_getiotgroupinfo.html -->
...
| errcode | number | 错误码 |
| errmsg | string | 错误信息 |
| group_name | string | 设备名称 |
| device_list | objarray | 设备列表 |
| model_id | string | 设备型号的唯一标识 |
| model_type | string | 设备类型 |
